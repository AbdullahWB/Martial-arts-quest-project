        ...
        <>
            ...
            >
                <div>
                    ...
                    <div>
                        <div className='w-full hidden md:flex py-2 justify-center items-center bg-gray-200 rounded-md mx-auto'>
                            <img
                                className='hidden md:block'
                                width='100'
                                height='100'
                        ...
                        <nav>
                            <>
                                ...
                                >
                                    ...
                                    />
                                    <span className='px-4 py-1 rounded-l-md bg-primary peer-checked:bg-gray-300 text-white'>
                                        Guest
                                    </span>
